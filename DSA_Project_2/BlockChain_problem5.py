...
class BlockChain:
    ...
    def search(self, data):
        ...
        if head.previous_hash == 0 and head.data == data:
            return True
...
print(blockchain.size())
print(blockchain.search(4))
print(blockchain.search(10))
blockchain.append(30)
blockchain.append(40)
blockchain.append(50)
blockchain.append(100)
print(blockchain.size())
#print(blockchain.to_list())
print(blockchain.search(40))
print(blockchain.search(0))